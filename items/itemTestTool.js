...
maxDamage = 0;//最大耐久
maxStack = 64//最大堆叠
name = "itemTestTool";//名称
toolClass = "pickaxe";//工具类型
full3d = true;//是否持剑型握物品
...
/*贴图*/
textureFile[0] = "itemTestTool0.png";

/*触发器*/
onUse[0]="mod.loadScript('Test0.js');";

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*元数据1*/
/*属性*/
efficiency[1] = 1.0;//对应方块采掘速度加成
information[1] = "输出枝芽信息";//显示信息
...
/*贴图*/
textureFile[1] = "itemTestTool1.png";

/*触发器*/
onUse[1]="mod.loadScript('Test1.js');";
