/*草衣*/
/*通用属性*/
anvilMaterial = "jinshucraft:itemBark:1";//铁砧修复材料
/*containerItem = "";//乘装容器*/
...
information[0] = "§8青箬笠，绿蓑衣，斜风细雨不须归";//显示信息
maxUsingDuration[0] = 1;//使用物品最大时间
usingAction[0] = "block";//使用时玩家动作

/*布尔值*/
addToCreative[0] = true;//是否添加到创造标签下
hasEffect[0] = true;//是否能附魔

/*贴图*/
textureFile[0] = "itemGrassBoots.png";
armorTexture = "itemGrassModel_1.png";
