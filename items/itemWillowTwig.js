...
/*贴图*/
textureFile[0] = "itemWillowTwig.png";

/*触发器*/
onHitEntity[0] = "if(Math.random()<0.03){itemstack.setStackSize(itemstack.getStackSize()-1);};";