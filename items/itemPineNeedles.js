...
harvestLevel = 0;//挖掘等级
information[0] = "§8听说它能泡茶，也能干吃";//显示信息
maxDamage = 0;//最大耐久
maxStack = 64//最大堆叠
maxUsingDuration[0] = 40;//使用物品最大时间
name = "itemPineNeedles";//名称
...
/*特殊*/
alwaysEdible[0] = true;//是否饱食度满时也能使用
hunger[0] = 1;//回复饥饿度
potion[0] = "weakness"//;使用后药水效果
potionAmplifier[0] = 0;//药水效果等级
potionDuration[0] = 8;//药水效果时长秒数
potionProbability[0] = 0.6;//药水效果添加概率
saturation[0] = 0.5;//增加饱食度

/*贴图*/
textureFile[0] = "itemPineNeedles.png";
