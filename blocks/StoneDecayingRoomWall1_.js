...
material = "rock";//材料类型
maxStack = 64;//最大堆叠
name = "StoneDecayingRoomWall1_";//名称
opacity = 255;//遮光率
...
light[0] = 0;//光照强度
pick[0] = "StoneDecayingRoomWall1_:0 1";//鼠标中键获得方块
/*tileEntity[0] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[0] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[0] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[0] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[0] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[0] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[0] = "StoneDecayingRoomWall0_1.png";//南面贴图
...
light[1] = 0;//光照强度
pick[1] = "StoneDecayingRoomWall1_:1 1";//鼠标中键获得方块
/*tileEntity[1] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[1] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[1] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[1] = "StoneDecayingRoomWall1_2.png";//底部贴图
textureFileYP[1] = "StoneDecayingRoomWall1_2.png";//顶部贴图
textureFileZN[1] = "StoneDecayingRoomWall1_4.png";//北面贴图
textureFileZP[1] = "StoneDecayingRoomWall1_2.png";//南面贴图
...
light[2] = 0;//光照强度
pick[2] = "StoneDecayingRoomWall1_:2 1";//鼠标中键获得方块
/*tileEntity[2] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[2] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[2] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[2] = "StoneDecayingRoomWall1_4.png";//底部贴图
textureFileYP[2] = "StoneDecayingRoomWall1_4.png";//顶部贴图
textureFileZN[2] = "StoneDecayingRoomWall1_2.png";//北面贴图
textureFileZP[2] = "StoneDecayingRoomWall1_4.png";//南面贴图
...
light[3] = 0;//光照强度
pick[3] = "StoneDecayingRoomWall1_:3 1";//鼠标中键获得方块
/*tileEntity[3] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[3] = "StoneDecayingRoomWall1_1.png";//西面贴图
textureFileXP[3] = "StoneDecayingRoomWall1_1.png";//东面贴图
textureFileYN[3] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[3] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[3] = "StoneDecayingRoomWall1_1.png";//北面贴图
textureFileZP[3] = "StoneDecayingRoomWall1_1.png";//南面贴图
...
light[4] = 0;//光照强度
pick[4] = "StoneDecayingRoomWall1_:4 1";//鼠标中键获得方块
/*tileEntity[4] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[4] = "StoneDecayingRoomWall1_3.png";//西面贴图
textureFileXP[4] = "StoneDecayingRoomWall1_3.png";//东面贴图
textureFileYN[4] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[4] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[4] = "StoneDecayingRoomWall1_3.png";//北面贴图
...
light[5] = 0;//光照强度
pick[5] = "StoneDecayingRoomWall1_:5 1";//鼠标中键获得方块
/*tileEntity[5] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[5] = "StoneDecayingRoomWall1_2.png";//西面贴图
textureFileXP[5] = "StoneDecayingRoomWall1_4.png";//东面贴图
textureFileYN[5] = "StoneDecayingRoomWall1_3.png";//底部贴图
textureFileYP[5] = "StoneDecayingRoomWall1_3.png";//顶部贴图
textureFileZN[5] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[5] = "StoneDecayingRoomWall1_1.png";//南面贴图
...
light[6] = 0;//光照强度
pick[6] = "StoneDecayingRoomWall1_:6 1";//鼠标中键获得方块
/*tileEntity[6] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[6] = "StoneDecayingRoomWall1_4.png";//西面贴图
textureFileXP[6] = "StoneDecayingRoomWall1_2.png";//东面贴图
textureFileYN[6] = "StoneDecayingRoomWall1_1.png";//底部贴图
textureFileYP[6] = "StoneDecayingRoomWall1_1.png";//顶部贴图
textureFileZN[6] = "StoneDecayingRoomWall1_2.png";//北面贴图
textureFileZP[6] = "StoneDecayingRoomWall0_1.png";//南面贴图
...
light[7] = 0;//光照强度
pick[7] = "StoneDecayingRoomWall1_:7 1";//鼠标中键获得方块
/*tileEntity[7] = "";//方块实体值*/
...
textureFileYN[7] = "StoneDecayingRoomWall2_5.png";//底部贴图
textureFileYP[7] = "StoneDecayingRoomWall2_5.png";//顶部贴图
textureFileZN[7] = "StoneDecayingRoomWall2_5.png";//北面贴图
textureFileZP[7] = "StoneDecayingRoomWall2_5.png";//南面贴图
...
light[8] = 0;//光照强度
pick[8] = "StoneDecayingRoomWall1_:8 1";//鼠标中键获得方块
/*tileEntity[8] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[8] = "StoneDecayingRoomWall1_1.png";//西面贴图
textureFileXP[8] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[8] = "StoneDecayingRoomWall1_2.png";//底部贴图
textureFileYP[8] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[8] = "StoneDecayingRoomWall2_3.png";//北面贴图
textureFileZP[8] = "StoneDecayingRoomWall2_1.png";//南面贴图
...
light[9] = 0;//光照强度
pick[9] = "StoneDecayingRoomWall1_:9 1";//鼠标中键获得方块
/*tileEntity[9] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[9] = "StoneDecayingRoomWall1_3.png";//西面贴图
textureFileXP[9] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[9] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[9] = "StoneDecayingRoomWall1_2.png";//顶部贴图
textureFileZN[9] = "StoneDecayingRoomWall2_6.png";//北面贴图
textureFileZP[9] = "StoneDecayingRoomWall2_4.png";//南面贴图
...
light[10] = 0;//光照强度
pick[10] = "StoneDecayingRoomWall1_:10 1";//鼠标中键获得方块
/*tileEntity[10] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[10] = "StoneDecayingRoomWall1_2.png";//西面贴图
textureFileXP[10] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[10] = "StoneDecayingRoomWall2_4.png";//底部贴图
textureFileYP[10] = "StoneDecayingRoomWall2_4.png";//顶部贴图
textureFileZN[10] = "StoneDecayingRoomWall1_4.png";//北面贴图
textureFileZP[10] = "StoneDecayingRoomWall0_1.png";//南面贴图
...
light[11] = 0;//光照强度
pick[11] = "StoneDecayingRoomWall1_:11 1";//鼠标中键获得方块
/*tileEntity[11] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[11] = "StoneDecayingRoomWall1_4.png";//西面贴图
textureFileXP[11] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[11] = "StoneDecayingRoomWall2_1.png";//底部贴图
textureFileYP[11] = "StoneDecayingRoomWall2_1.png";//顶部贴图
textureFileZN[11] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[11] = "StoneDecayingRoomWall1_2.png";//南面贴图
...
light[12] = 0;//光照强度
pick[12] = "StoneDecayingRoomWall1_:12 1";//鼠标中键获得方块
/*tileEntity[12] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[12] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[12] = "StoneDecayingRoomWall1_1.png";//东面贴图
textureFileYN[12] = "StoneDecayingRoomWall1_4.png";//底部贴图
textureFileYP[12] = "StoneDecayingRoomWall2_5.png";//顶部贴图
textureFileZN[12] = "StoneDecayingRoomWall2_1.png";//北面贴图
textureFileZP[12] = "StoneDecayingRoomWall2_3.png";//南面贴图
...
light[13] = 0;//光照强度
pick[13] = "StoneDecayingRoomWall1_:13 1";//鼠标中键获得方块
/*tileEntity[13] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[13] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[13] = "StoneDecayingRoomWall1_3.png";//东面贴图
textureFileYN[13] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[13] = "StoneDecayingRoomWall1_4.png";//顶部贴图
textureFileZN[13] = "StoneDecayingRoomWall2_4.png";//北面贴图
textureFileZP[13] = "StoneDecayingRoomWall2_6.png";//南面贴图
...
light[14] = 0;//光照强度
pick[14] = "StoneDecayingRoomWall1_:14 1";//鼠标中键获得方块
/*tileEntity[14] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[14] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[14] = "StoneDecayingRoomWall1_4.png";//东面贴图
textureFileYN[14] = "StoneDecayingRoomWall2_6.png";//底部贴图
textureFileYP[14] = "StoneDecayingRoomWall2_6.png";//顶部贴图
textureFileZN[14] = "StoneDecayingRoomWall1_2.png";//北面贴图
textureFileZP[14] = "StoneDecayingRoomWall0_1.png";//南面贴图
...
light[15] = 0;//光照强度
pick[15] = "StoneDecayingRoomWall1_:15 1";//鼠标中键获得方块
/*tileEntity[15] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[15] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[15] = "StoneDecayingRoomWall1_2.png";//东面贴图
textureFileYN[15] = "StoneDecayingRoomWall2_3.png";//底部贴图
textureFileYP[15] = "StoneDecayingRoomWall2_3.png";//顶部贴图
textureFileZN[15] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[15] = "StoneDecayingRoomWall1_4.png";//南面贴图
