...
drop[0] = "jinshucraft:StoneDecayingRoomOutput";//掉落物
expDrop[0] = "0";//经验掉落
...
information[0] = "§8唰唰唰...||§3采集上方5*7*5范围|§4每腐化方块掉落期望:3.7个腐殖质";//显示信息
light[0] = 0;//光照强度
material = "rock";//材料类型
maxStack = 64;//最大堆叠
name = "StoneDecayingRoomOutput";//名称
opacity = 255;//遮光率
pick[0] = "StoneDecayingRoomOutput:0 1";//鼠标中键获得方块
...
textureFileYN[0] = "StoneDecayingRoomOutput_Top.png";//底部贴图
textureFileYP[0] = "StoneDecayingRoomOutput_Top.png";//顶部贴图
textureFileZN[0] = "StoneDecayingRoom.png";//北面贴图
textureFileZP[0] = "StoneDecayingRoom.png";//南面贴图

/*触发器*/
onClicked[0] = "if(player.getItemName(player.getCurrentSlot())==null){mod.loadScript('StoneDecayingRoomOutput.js');}else{position.y++;if(world.getBlockName(position)=='minecraft:air'){mod.loadScript('DecayBlockPlace.js');};}";