...
drop[0] = "jinshucraft:PineWood";//掉落物
expDrop[0] = "0";//经验掉落
...
information[0] = "§8你是怎么抠下它的？";//显示信息
light[0] = 0;//光照强度
material = "wood";//材料类型
maxStack = 64;//最大堆叠
name = "PineWood";//名称
opacity = 255;//遮光率
pick[0] = "PineWood:0 1";//鼠标中键获得方块
...
textureFileSides[0] = "PineWood.png";//边面贴图

/*触发器*/
onNeighborChange[0] = "mod.loadScript('WoodenDryingRoomPineWoodCheck.js');";
...
/*属性*/
creativeTab = "_Wood";//所在标签
drop[1] = "jinshucraft:PineWood";//掉落物
expDrop[1] = "0";//经验掉落
...
information[1] = "§8你是怎么抠下它的？";//显示信息
light[1] = 0;//光照强度
material = "wood";//材料类型
maxStack = 64;//最大堆叠
name = "PineWood";//名称
opacity = 255;//遮光率
pick[1] = "PineWood:0 1";//鼠标中键获得方块
...
textureFileSides[1] = "PineWood.png";//边面贴图

/*触发器*/
onNeighborChange[1] = "mod.loadScript('WoodenDryingRoomPineWoodCheck.js');";
