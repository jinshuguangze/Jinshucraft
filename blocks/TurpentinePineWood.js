...
information[0] = "§8油油的手感";//显示信息
light[0] = 0;//光照强度
material = "wood";//材料类型
maxStack = 64;//最大堆叠
name = "TurpentinePineWood";//名称
opacity = 255;//遮光率
pick[0] = "TurpentinePineWood:0 1";//鼠标中键获得方块
...
textureFileSides[0] = "TurpentinePineWood.png";//边面贴图
...
information[1] = "§8油油的手感";//显示信息
light[1] = 0;//光照强度
material = "wood";//材料类型
maxStack = 64;//最大堆叠
name = "TurpentinePineWood";//名称
opacity = 255;//遮光率
pick[1] = "TurpentinePineWood:0 1";//鼠标中键获得方块
...
textureFileSides[1] = "TurpentinePineWood.png";//边面贴图
