...
information[0] = "§8一股恶心的味道";//显示信息
light[0] = 0;//光照强度
pick[0] = "DecayedBlock:0 1";//鼠标中键获得方块
resistance[0] = 0;//爆炸抗性
/*tileEntity[0] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[0] = "DecayedBlock0.png";//西面贴图
textureFileXP[0] = "DecayedBlock0.png";//东面贴图
textureFileYN[0] = "DecayedBlock0.png";//底部贴图
textureFileYP[0] = "DecayedBlock0.png";//顶部贴图
textureFileZN[0] = "DecayedBlock0.png";//北面贴图
textureFileZP[0] = "DecayedBlock0.png";//南面贴图
