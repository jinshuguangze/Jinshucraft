...
information[0] = "§8它似乎开始腐烂了";//显示信息
light[0] = 0;//光照强度
pick[0] = "DecayingBlock:0 1";//鼠标中键获得方块
resistance[0] = 0;//爆炸抗性
/*tileEntity[0] = "";//方块实体值*/
...
onUpdate[0] = "mod.loadScript('DecayingNeighborhoodCheck.js');";
...
information[1] = "§8它似乎开始腐烂了";//显示信息
light[1] = 0;//光照强度
pick[1] = "DecayingBlock:1 1";//鼠标中键获得方块
resistance[1] = 0;//爆炸抗性
/*tileEntity[1] = "";//方块实体值*/
...
onUpdate[1] = "mod.loadScript('DecayingNeighborhoodCheck.js');";
...
information[2] = "§8它似乎开始腐烂了";//显示信息
light[2] = 0;//光照强度
pick[2] = "DecayingBlock:2 1";//鼠标中键获得方块
resistance[2] = 0;//爆炸抗性
/*tileEntity[2] = "";//方块实体值*/
...
onUpdate[2] = "mod.loadScript('DecayingNeighborhoodCheck.js');";
...
information[3] = "§8它似乎开始腐烂了";//显示信息
light[3] = 0;//光照强度
pick[3] = "DecayingBlock:3 1";//鼠标中键获得方块
resistance[3] = 0;//爆炸抗性
/*tileEntity[3] = "";//方块实体值*/
...
onUpdate[3] = "mod.loadScript('DecayingNeighborhoodCheck.js');";
...
information[4] = "§8它似乎开始腐烂了";//显示信息
light[4] = 0;//光照强度
pick[4] = "DecayingBlock:4 1";//鼠标中键获得方块
resistance[4] = 0;//爆炸抗性
/*tileEntity[4] = "";//方块实体值*/
...
onUpdate[4] = "mod.loadScript('DecayingNeighborhoodCheck.js');";
...
information[5] = "§8它似乎开始腐烂了";//显示信息
light[5] = 0;//光照强度
pick[5] = "DecayingBlock:5 1";//鼠标中键获得方块
resistance[5] = 0;//爆炸抗性
/*tileEntity[5] = "";//方块实体值*/
...
onUpdate[5] = "mod.loadScript('DecayingNeighborhoodCheck.js');";
...
information[6] = "§8它似乎开始腐烂了";//显示信息
light[6] = 0;//光照强度
pick[6] = "DecayingBlock:6 1";//鼠标中键获得方块
resistance[6] = 0;//爆炸抗性
/*tileEntity[6] = "";//方块实体值*/
...
onUpdate[6] = "mod.loadScript('DecayingNeighborhoodCheck.js');";
