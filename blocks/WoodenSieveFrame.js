...
/*元数据0*/
/*属性*/
drop[0] = "jinshucraft:WoodenSieveFrame:0";//掉落物
expDrop[0] = "0";//经验掉落
...
information[0] = "§8蹦蹦床...?";//显示信息
light[0] = 0;//光照强度
pick[0] = "jinshucraft:WoodenSieveFrame:0";//鼠标中键获得方块
resistance[0] = 0;//爆炸抗性
/*tileEntity[0] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[0] = "WoodenSieveFrame.png";//西面贴图
textureFileXP[0] = "WoodenSieveFrame.png";//东面贴图
textureFileYN[0] = "WoodenSieveFrame.png";//底部贴图
textureFileYP[0] = "WoodenSieveFrame.png";//顶部贴图
textureFileZN[0] = "WoodenSieveFrame.png";//北面贴图
textureFileZP[0] = "WoodenSieveFrame.png";//南面贴图

/*触发器*/
onActivated[0] = "mod.loadScript('SieveNetTypeSelect.js');";
onBreak[0] = "mod.loadScript('FrameBreak.js');";
