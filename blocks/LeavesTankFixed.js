...
/*元数据0*/
/*属性*/
drop[0] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[0] = "0";//经验掉落
...
information[0] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 0 mb 水";//显示信息
light[0] = 0;//光照强度
pick[0] = "LeavesTankFixed:0 1";//鼠标中键获得方块
resistance[0] = 0;//爆炸抗性
/*tileEntity[0] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[0] = "LeavesTankFixed0.png";//西面贴图
textureFileXP[0] = "LeavesTankFixed0.png";//东面贴图
textureFileYN[0] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[0] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[0] = "LeavesTankFixed0.png";//北面贴图
textureFileZP[0] = "LeavesTankFixed0.png";//南面贴图
...
/*元数据1*/
/*属性*/
drop[1] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[1] = "0";//经验掉落
fireSpreadSpeed[1] = 20;//火焰蔓延速度
flammability[1] = 50;//易燃性
fortuneModifier[1] = 0;//时运采集增产
hardness[1] = 2;//空手破坏时间
harvestLevel[1] = 0;//挖掘等级
information[1] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 200 mb 水";//显示信息
light[1] = 0;//光照强度
pick[1] = "LeavesTankFixed:1 1";//鼠标中键获得方块
resistance[1] = 0;//爆炸抗性
/*tileEntity[1] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[1] = "LeavesTankFixed1.png";//西面贴图
textureFileXP[1] = "LeavesTankFixed1.png";//东面贴图
textureFileYN[1] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[1] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[1] = "LeavesTankFixed1.png";//北面贴图
textureFileZP[1] = "LeavesTankFixed1.png";//南面贴图
...
/*元数据2*/
/*属性*/
drop[2] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[2] = "0";//经验掉落
...
information[2] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 400 mb 水";//显示信息
light[2] = 0;//光照强度
pick[2] = "LeavesTankFixed:2 1";//鼠标中键获得方块
resistance[2] = 0;//爆炸抗性
/*tileEntity[2] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[2] = "LeavesTankFixed2.png";//西面贴图
textureFileXP[2] = "LeavesTankFixed2.png";//东面贴图
textureFileYN[2] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[2] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[2] = "LeavesTankFixed2.png";//北面贴图
textureFileZP[2] = "LeavesTankFixed2.png";//南面贴图
...
/*元数据3*/
/*属性*/
drop[3] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[3] = "0";//经验掉落
fireSpreadSpeed[3] = 20;//火焰蔓延速度
flammability[3] = 50;//易燃性
fortuneModifier[3] = 0;//时运采集增产
hardness[3] = 2;//空手破坏时间
harvestLevel[3] = 0;//挖掘等级
information[3] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 600 mb 水";//显示信息
light[3] = 0;//光照强度
pick[3] = "LeavesTankFixed:3 1";//鼠标中键获得方块
resistance[3] = 0;//爆炸抗性
/*tileEntity[3] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[3] = "LeavesTankFixed3.png";//西面贴图
textureFileXP[3] = "LeavesTankFixed3.png";//东面贴图
textureFileYN[3] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[3] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[3] = "LeavesTankFixed3.png";//北面贴图
textureFileZP[3] = "LeavesTankFixed3.png";//南面贴图
...
/*元数据4*/
/*属性*/
drop[4] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[4] = "0";//经验掉落
fireSpreadSpeed[4] = 20;//火焰蔓延速度
flammability[4] = 50;//易燃性
fortuneModifier[4] = 0;//时运采集增产
hardness[4] = 2;//空手破坏时间
harvestLevel[4] = 0;//挖掘等级
information[4] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 800 mb 水";//显示信息
light[4] = 0;//光照强度
pick[4] = "LeavesTankFixed:4 1";//鼠标中键获得方块
resistance[4] = 0;//爆炸抗性
/*tileEntity[4] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[4] = "LeavesTankFixed4.png";//西面贴图
textureFileXP[4] = "LeavesTankFixed4.png";//东面贴图
textureFileYN[4] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[4] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[4] = "LeavesTankFixed4.png";//北面贴图
textureFileZP[4] = "LeavesTankFixed4.png";//南面贴图
...
/*元数据5*/
/*属性*/
drop[5] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[5] = "0";//经验掉落
fireSpreadSpeed[5] = 20;//火焰蔓延速度
flammability[5] = 50;//易燃性
fortuneModifier[5] = 0;//时运采集增产
hardness[5] = 2;//空手破坏时间
harvestLevel[5] = 0;//挖掘等级
information[5] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 1000 mb 水";//显示信息
light[5] = 0;//光照强度
pick[5] = "LeavesTankFixed:5 1";//鼠标中键获得方块
resistance[5] = 0;//爆炸抗性
/*tileEntity[5] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[5] = "LeavesTankFixed5.png";//西面贴图
textureFileXP[5] = "LeavesTankFixed5.png";//东面贴图
textureFileYN[5] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[5] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[5] = "LeavesTankFixed5.png";//北面贴图
textureFileZP[5] = "LeavesTankFixed5.png";//南面贴图
...
/*元数据6*/
/*属性*/
drop[6] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[6] = "0";//经验掉落
fireSpreadSpeed[6] = 20;//火焰蔓延速度
flammability[6] = 50;//易燃性
fortuneModifier[6] = 0;//时运采集增产
hardness[6] = 2;//空手破坏时间
harvestLevel[6] = 0;//挖掘等级
information[6] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 1200 mb 水";//显示信息
light[6] = 0;//光照强度
pick[6] = "LeavesTankFixed:6 1";//鼠标中键获得方块
resistance[6] = 0;//爆炸抗性
/*tileEntity[6] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[6] = "LeavesTankFixed6.png";//西面贴图
textureFileXP[6] = "LeavesTankFixed6.png";//东面贴图
textureFileYN[6] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[6] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[6] = "LeavesTankFixed6.png";//北面贴图
textureFileZP[6] = "LeavesTankFixed6.png";//南面贴图
...
/*元数据7*/
/*属性*/
drop[7] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[7] = "0";//经验掉落
fireSpreadSpeed[7] = 20;//火焰蔓延速度
flammability[7] = 50;//易燃性
fortuneModifier[7] = 0;//时运采集增产
hardness[7] = 2;//空手破坏时间
harvestLevel[7] = 0;//挖掘等级
information[7] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 1400 mb 水";//显示信息
light[7] = 0;//光照强度
pick[7] = "LeavesTankFixed:7 1";//鼠标中键获得方块
resistance[7] = 0;//爆炸抗性
/*tileEntity[7] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[7] = "LeavesTankFixed7.png";//西面贴图
textureFileXP[7] = "LeavesTankFixed7.png";//东面贴图
textureFileYN[7] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[7] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[7] = "LeavesTankFixed7.png";//北面贴图
textureFileZP[7] = "LeavesTankFixed7.png";//南面贴图
...
/*元数据8*/
/*属性*/
drop[8] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[8] = "0";//经验掉落
fireSpreadSpeed[8] = 20;//火焰蔓延速度
flammability[8] = 50;//易燃性
fortuneModifier[8] = 0;//时运采集增产
hardness[8] = 2;//空手破坏时间
harvestLevel[8] = 0;//挖掘等级
information[8] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 1600 mb 水";//显示信息
light[8] = 0;//光照强度
pick[8] = "LeavesTankFixed:8 1";//鼠标中键获得方块
resistance[8] = 0;//爆炸抗性
/*tileEntity[8] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[8] = "LeavesTankFixed8.png";//西面贴图
textureFileXP[8] = "LeavesTankFixed8.png";//东面贴图
textureFileYN[8] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[8] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[8] = "LeavesTankFixed8.png";//北面贴图
textureFileZP[8] = "LeavesTankFixed8.png";//南面贴图
...
/*元数据9*/
/*属性*/
drop[9] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[9] = "0";//经验掉落
fireSpreadSpeed[9] = 20;//火焰蔓延速度
flammability[9] = 50;//易燃性
fortuneModifier[9] = 0;//时运采集增产
hardness[9] = 2;//空手破坏时间
harvestLevel[9] = 0;//挖掘等级
information[9] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 1800 mb 水";//显示信息
light[9] = 0;//光照强度
pick[9] = "LeavesTankFixed:9 1";//鼠标中键获得方块
resistance[9] = 0;//爆炸抗性
/*tileEntity[9] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[9] = "LeavesTankFixed9.png";//西面贴图
textureFileXP[9] = "LeavesTankFixed9.png";//东面贴图
textureFileYN[9] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[9] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[9] = "LeavesTankFixed9.png";//北面贴图
textureFileZP[9] = "LeavesTankFixed9.png";//南面贴图
...
/*元数据10*/
/*属性*/
drop[10] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[10] = "0";//经验掉落
fireSpreadSpeed[10] = 20;//火焰蔓延速度
flammability[10] = 50;//易燃性
fortuneModifier[10] = 0;//时运采集增产
hardness[10] = 2;//空手破坏时间
harvestLevel[10] = 0;//挖掘等级
information[10] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 2000 mb 水";//显示信息
light[10] = 0;//光照强度
pick[10] = "LeavesTankFixed:10 1";//鼠标中键获得方块
...
/*贴图*/
textureFileXN[10] = "LeavesTankFixed10.png";//西面贴图
textureFileXP[10] = "LeavesTankFixed10.png";//东面贴图
textureFileYN[10] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[10] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[10] = "LeavesTankFixed10.png";//北面贴图
textureFileZP[10] = "LeavesTankFixed10.png";//南面贴图
...
/*元数据11*/
/*属性*/
drop[11] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[11] = "0";//经验掉落
fireSpreadSpeed[11] = 20;//火焰蔓延速度
flammability[11] = 50;//易燃性
fortuneModifier[11] = 0;//时运采集增产
hardness[11] = 2;//空手破坏时间
harvestLevel[11] = 0;//挖掘等级
information[11] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 2200 mb 水";//显示信息
light[11] = 0;//光照强度
pick[11] = "LeavesTankFixed:11 1";//鼠标中键获得方块
...
/*贴图*/
textureFileXN[11] = "LeavesTankFixed11.png";//西面贴图
textureFileXP[11] = "LeavesTankFixed11.png";//东面贴图
textureFileYN[11] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[11] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[11] = "LeavesTankFixed11.png";//北面贴图
textureFileZP[11] = "LeavesTankFixed11.png";//南面贴图
...
/*元数据12*/
/*属性*/
drop[12] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[12] = "0";//经验掉落
fireSpreadSpeed[12] = 20;//火焰蔓延速度
flammability[12] = 50;//易燃性
fortuneModifier[12] = 0;//时运采集增产
hardness[12] = 2;//空手破坏时间
harvestLevel[12] = 0;//挖掘等级
information[12] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 2400 mb 水";//显示信息
light[12] = 0;//光照强度
pick[12] = "LeavesTankFixed:12 1";//鼠标中键获得方块
...
/*贴图*/
textureFileXN[12] = "LeavesTankFixed12.png";//西面贴图
textureFileXP[12] = "LeavesTankFixed12.png";//东面贴图
textureFileYN[12] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[12] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[12] = "LeavesTankFixed12.png";//北面贴图
textureFileZP[12] = "LeavesTankFixed12.png";//南面贴图
...
/*元数据13*/
/*属性*/
drop[13] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[13] = "0";//经验掉落
fireSpreadSpeed[13] = 20;//火焰蔓延速度
flammability[13] = 50;//易燃性
fortuneModifier[13] = 0;//时运采集增产
hardness[13] = 2;//空手破坏时间
harvestLevel[13] = 0;//挖掘等级
information[13] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 2600 mb 水";//显示信息
light[13] = 0;//光照强度
pick[13] = "LeavesTankFixed:13 1";//鼠标中键获得方块
...
/*贴图*/
textureFileXN[13] = "LeavesTankFixed13.png";//西面贴图
textureFileXP[13] = "LeavesTankFixed13.png";//东面贴图
textureFileYN[13] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[13] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[13] = "LeavesTankFixed13.png";//北面贴图
textureFileZP[13] = "LeavesTankFixed13.png";//南面贴图
...
/*元数据14*/
/*属性*/
drop[14] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[14] = "0";//经验掉落
fireSpreadSpeed[14] = 20;//火焰蔓延速度
flammability[14] = 50;//易燃性
fortuneModifier[14] = 0;//时运采集增产
hardness[14] = 2;//空手破坏时间
harvestLevel[14] = 0;//挖掘等级
information[14] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 2800 mb 水";//显示信息
light[14] = 0;//光照强度
pick[14] = "LeavesTankFixed:14 1";//鼠标中键获得方块
...
/*贴图*/
textureFileXN[14] = "LeavesTankFixed14.png";//西面贴图
textureFileXP[14] = "LeavesTankFixed14.png";//东面贴图
textureFileYN[14] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[14] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[14] = "LeavesTankFixed14.png";//北面贴图
textureFileZP[14] = "LeavesTankFixed14.png";//南面贴图
...
/*元数据15*/
/*属性*/
drop[15] = "jinshucraft:LeavesTankFixed:0";//掉落物
expDrop[15] = "0";//经验掉落
fireSpreadSpeed[15] = 20;//火焰蔓延速度
flammability[15] = 50;//易燃性
fortuneModifier[15] = 0;//时运采集增产
hardness[15] = 2;//空手破坏时间
harvestLevel[15] = 0;//挖掘等级
information[15] = "§8经过松脂粘黏,我保证它不会再漏水了...||§c已储存: 3000 mb 水";//显示信息
light[15] = 0;//光照强度
pick[15] = "LeavesTankFixed:15 1";//鼠标中键获得方块
...
/*贴图*/
textureFileXN[15] = "LeavesTankFixed15.png";//西面贴图
textureFileXP[15] = "LeavesTankFixed15.png";//东面贴图
textureFileYN[15] = "LeavesTankFixed_Bottom.png";//底部贴图
textureFileYP[15] = "LeavesTankFixed_Top.png";//顶部贴图
textureFileZN[15] = "LeavesTankFixed15.png";//北面贴图
textureFileZP[15] = "LeavesTankFixed15.png";//南面贴图
