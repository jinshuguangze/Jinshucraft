...
material = "wood";//材料类型
maxStack = 64;//最大堆叠
name = "WoodenDecayingRoomWall2_";//名称
opacity = 255;//遮光率
...
light[0] = 0;//光照强度
pick[0] = "WoodenDecayingRoomWall2_:0 1";//鼠标中键获得方块
/*tileEntity[0] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[0] = "WoodenDecayingRoomWall2_2.png";//西面贴图
textureFileXP[0] = "WoodenDecayingRoomWall2_2.png";//东面贴图
textureFileYN[0] = "WoodenDecayingRoomWall0_1.png";//底部贴图
textureFileYP[0] = "WoodenDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[0] = "WoodenDecayingRoomWall2_2.png";//北面贴图
textureFileZP[0] = "WoodenDecayingRoomWall2_2.png";//南面贴图
...
light[1] = 0;//光照强度
pick[1] = "WoodenDecayingRoomWall2_:1 1";//鼠标中键获得方块
/*tileEntity[1] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[1] = "WoodenDecayingRoomWall2_1.png";//西面贴图
textureFileXP[1] = "WoodenDecayingRoomWall2_3.png";//东面贴图
textureFileYN[1] = "WoodenDecayingRoomWall1_3.png";//底部贴图
textureFileYP[1] = "WoodenDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[1] = "WoodenDecayingRoomWall1_1.png";//北面贴图
textureFileZP[1] = "WoodenDecayingRoomWall0_1.png";//南面贴图
...
light[2] = 0;//光照强度
pick[2] = "WoodenDecayingRoomWall2_:2 1";//鼠标中键获得方块
/*tileEntity[2] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[2] = "WoodenDecayingRoomWall2_3.png";//西面贴图
textureFileXP[2] = "WoodenDecayingRoomWall2_1.png";//东面贴图
textureFileYN[2] = "WoodenDecayingRoomWall1_1.png";//底部贴图
textureFileYP[2] = "WoodenDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[2] = "WoodenDecayingRoomWall0_1.png";//北面贴图
textureFileZP[2] = "WoodenDecayingRoomWall1_1.png";//南面贴图
...
light[3] = 0;//光照强度
pick[3] = "WoodenDecayingRoomWall2_:3 1";//鼠标中键获得方块
/*tileEntity[3] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[3] = "WoodenDecayingRoomWall2_4.png";//西面贴图
textureFileXP[3] = "WoodenDecayingRoomWall2_6.png";//东面贴图
textureFileYN[3] = "WoodenDecayingRoomWall0_1.png";//底部贴图
textureFileYP[3] = "WoodenDecayingRoomWall1_3.png";//顶部贴图
textureFileZN[3] = "WoodenDecayingRoomWall1_3.png";//北面贴图
...
light[4] = 0;//光照强度
pick[4] = "WoodenDecayingRoomWall2_:4 1";//鼠标中键获得方块
/*tileEntity[4] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[4] = "WoodenDecayingRoomWall2_6.png";//西面贴图
textureFileXP[4] = "WoodenDecayingRoomWall2_4.png";//东面贴图
textureFileYN[4] = "WoodenDecayingRoomWall0_1.png";//底部贴图
textureFileYP[4] = "WoodenDecayingRoomWall1_1.png";//顶部贴图
textureFileZN[4] = "WoodenDecayingRoomWall0_1.png";//北面贴图
...
light[5] = 0;//光照强度
pick[5] = "WoodenDecayingRoomWall2_:5 1";//鼠标中键获得方块
/*tileEntity[5] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[5] = "WoodenDecayingRoomWall2_5.png";//西面贴图
textureFileXP[5] = "WoodenDecayingRoomWall2_5.png";//东面贴图
textureFileYN[5] = "WoodenDecayingRoomWall2_2.png";//底部贴图
textureFileYP[5] = "WoodenDecayingRoomWall2_2.png";//顶部贴图
textureFileZN[5] = "WoodenDecayingRoomWall2_5.png";//北面贴图
textureFileZP[5] = "WoodenDecayingRoomWall2_5.png";//南面贴图
...
light[6] = 0;//光照强度
pick[6] = "WoodenDecayingRoomWall2_:6 1";//鼠标中键获得方块
/*tileEntity[6] = "";//方块实体值*/
...
textureFileXP[6] = "WoodenDecayingRoomWall0_1.png";//东面贴图
textureFileYN[6] = "WoodenDecayingRoomWall2_5.png";//底部贴图
textureFileYP[6] = "WoodenDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[6] = "WoodenDecayingRoomWall3_2.png";//北面贴图
textureFileZP[6] = "WoodenDecayingRoomWall3_2.png";//南面贴图
...
light[7] = 0;//光照强度
pick[7] = "WoodenDecayingRoomWall2_:7 1";//鼠标中键获得方块
/*tileEntity[7] = "";//方块实体值*/
...
textureFileZN[7] = "WoodenDecayingRoomWall3_4.png";//北面贴图
textureFileZP[7] = "WoodenDecayingRoomWall3_4.png";//南面贴图
...
light[8] = 0;//光照强度
pick[8] = "WoodenDecayingRoomWall2_:8 1";//鼠标中键获得方块
/*tileEntity[8] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[8] = "WoodenDecayingRoomWall0_1.png";//西面贴图
textureFileXP[8] = "WoodenDecayingRoomWall0_1.png";//东面贴图
textureFileYN[8] = "WoodenDecayingRoomWall3_4.png";//底部贴图
textureFileYP[8] = "WoodenDecayingRoomWall3_4.png";//顶部贴图
textureFileZN[8] = "WoodenDecayingRoomWall2_5.png";//北面贴图
...
light[9] = 0;//光照强度
pick[9] = "WoodenDecayingRoomWall2_:9 1";//鼠标中键获得方块
/*tileEntity[9] = "";//方块实体值*/
...
textureFileYN[9] = "WoodenDecayingRoomWall3_2.png";//底部贴图
textureFileYP[9] = "WoodenDecayingRoomWall3_2.png";//顶部贴图
textureFileZN[9] = "WoodenDecayingRoomWall0_1.png";//北面贴图
textureFileZP[9] = "WoodenDecayingRoomWall2_5.png";//南面贴图
...
light[10] = 0;//光照强度
pick[10] = "WoodenDecayingRoomWall2_:10 1";//鼠标中键获得方块
/*tileEntity[10] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[10] = "WoodenDecayingRoomWall2_2.png";//西面贴图
...
textureFileZN[10] = "WoodenDecayingRoomWall3_3.png";//北面贴图
textureFileZP[10] = "WoodenDecayingRoomWall3_1.png";//南面贴图
...
light[11] = 0;//光照强度
pick[11] = "WoodenDecayingRoomWall2_:11 1";//鼠标中键获得方块
/*tileEntity[11] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[11] = "WoodenDecayingRoomWall2_1.png";//西面贴图
textureFileXP[11] = "WoodenDecayingRoomWall0_1.png";//东面贴图
textureFileYN[11] = "WoodenDecayingRoomWall2_4.png";//底部贴图
textureFileYP[11] = "WoodenDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[11] = "WoodenDecayingRoomWall2_3.png";//北面贴图
...
light[12] = 0;//光照强度
pick[12] = "WoodenDecayingRoomWall2_:12 1";//鼠标中键获得方块
/*tileEntity[12] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[12] = "WoodenDecayingRoomWall2_3.png";//西面贴图
textureFileXP[12] = "WoodenDecayingRoomWall0_1.png";//东面贴图
textureFileYN[12] = "WoodenDecayingRoomWall2_1.png";//底部贴图
textureFileYP[12] = "WoodenDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[12] = "WoodenDecayingRoomWall0_1.png";//北面贴图
textureFileZP[12] = "WoodenDecayingRoomWall2_1.png";//南面贴图
...
light[13] = 0;//光照强度
pick[13] = "WoodenDecayingRoomWall2_:13 1";//鼠标中键获得方块
/*tileEntity[13] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[13] = "WoodenDecayingRoomWall2_4.png";//西面贴图
textureFileXP[13] = "WoodenDecayingRoomWall0_1.png";//东面贴图
textureFileYN[13] = "WoodenDecayingRoomWall0_1.png";//底部贴图
textureFileYP[13] = "WoodenDecayingRoomWall2_4.png";//顶部贴图
textureFileZN[13] = "WoodenDecayingRoomWall2_6.png";//北面贴图
...
light[14] = 0;//光照强度
pick[14] = "WoodenDecayingRoomWall2_:14 1";//鼠标中键获得方块
/*tileEntity[14] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[14] = "WoodenDecayingRoomWall2_6.png";//西面贴图
textureFileXP[14] = "WoodenDecayingRoomWall0_1.png";//东面贴图
textureFileYN[14] = "WoodenDecayingRoomWall0_1.png";//底部贴图
textureFileYP[14] = "WoodenDecayingRoomWall2_1.png";//顶部贴图
textureFileZN[14] = "WoodenDecayingRoomWall0_1.png";//北面贴图
textureFileZP[14] = "WoodenDecayingRoomWall2_4.png";//南面贴图
...
light[15] = 0;//光照强度
pick[15] = "WoodenDecayingRoomWall2_:15 1";//鼠标中键获得方块
/*tileEntity[15] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[15] = "WoodenDecayingRoomWall2_5.png";//西面贴图
textureFileXP[15] = "WoodenDecayingRoomWall0_1.png";//东面贴图
textureFileYN[15] = "WoodenDecayingRoomWall3_1.png";//底部贴图
textureFileYP[15] = "WoodenDecayingRoomWall3_1.png";//顶部贴图
