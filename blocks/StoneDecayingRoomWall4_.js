...
material = "rock";//材料类型
maxStack = 64;//最大堆叠
name = "StoneDecayingRoomWall4_";//名称
opacity = 255;//遮光率
...
light[0] = 0;//光照强度
pick[0] = "StoneDecayingRoomWall4_:0 1";//鼠标中键获得方块
/*tileEntity[0] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[0] = "StoneDecayingRoomWall3_1.png";//西面贴图
...
textureFileZN[0] = "StoneDecayingRoomWall3_3.png";//北面贴图
...
light[1] = 0;//光照强度
pick[1] = "StoneDecayingRoomWall4_:1 1";//鼠标中键获得方块
/*tileEntity[1] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[1] = "StoneDecayingRoomWall3_3.png";//西面贴图
textureFileXP[1] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[1] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[1] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[1] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[1] = "StoneDecayingRoomWall3_1.png";//南面贴图
...
light[2] = 0;//光照强度
pick[2] = "StoneDecayingRoomWall4_:2 1";//鼠标中键获得方块
/*tileEntity[2] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[2] = "StoneDecayingRoomWall3_2.png";//西面贴图
textureFileXP[2] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[2] = "StoneDecayingRoomWall3_1.png";//底部贴图
textureFileYP[2] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[2] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[2] = "StoneDecayingRoomWall0_1.png";//南面贴图
...
light[3] = 0;//光照强度
pick[3] = "StoneDecayingRoomWall4_:3 1";//鼠标中键获得方块
/*tileEntity[3] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[3] = "StoneDecayingRoomWall3_4.png";//西面贴图
textureFileXP[3] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[3] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[3] = "StoneDecayingRoomWall3_1.png";//顶部贴图
textureFileZN[3] = "StoneDecayingRoomWall0_1.png";//北面贴图
...
light[4] = 0;//光照强度
pick[4] = "StoneDecayingRoomWall4_:4 1";//鼠标中键获得方块
/*tileEntity[4] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[4] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[4] = "StoneDecayingRoomWall3_3.png";//东面贴图
textureFileYN[4] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[4] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[4] = "StoneDecayingRoomWall3_1.png";//北面贴图
textureFileZP[4] = "StoneDecayingRoomWall0_1.png";//南面贴图
...
light[5] = 0;//光照强度
pick[5] = "StoneDecayingRoomWall4_:5 1";//鼠标中键获得方块
/*tileEntity[5] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[5] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[5] = "StoneDecayingRoomWall3_1.png";//东面贴图
textureFileYN[5] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[5] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[5] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[5] = "StoneDecayingRoomWall3_3.png";//南面贴图
...
light[6] = 0;//光照强度
pick[6] = "StoneDecayingRoomWall4_:6 1";//鼠标中键获得方块
/*tileEntity[6] = "";//方块实体值*/
...
textureFileXP[6] = "StoneDecayingRoomWall3_2.png";//东面贴图
textureFileYN[6] = "StoneDecayingRoomWall3_3.png";//底部贴图
textureFileYP[6] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[6] = "StoneDecayingRoomWall0_1.png";//北面贴图
...
light[7] = 0;//光照强度
pick[7] = "StoneDecayingRoomWall4_:7 1";//鼠标中键获得方块
/*tileEntity[7] = "";//方块实体值*/
...
textureFileXP[7] = "StoneDecayingRoomWall3_4.png";//东面贴图
textureFileYN[7] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[7] = "StoneDecayingRoomWall3_3.png";//顶部贴图
textureFileZN[7] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[7] = "StoneDecayingRoomWall0_1.png";//南面贴图
...
light[8] = 0;//光照强度
pick[8] = "StoneDecayingRoomWall4_:8 1";//鼠标中键获得方块
/*tileEntity[8] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[8] = "StoneDecayingRoomWall4_1.png";//西面贴图
textureFileXP[8] = "StoneDecayingRoomWall4_1.png";//东面贴图
textureFileYN[8] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[8] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[8] = "StoneDecayingRoomWall0_1.png";//北面贴图
...
light[9] = 0;//光照强度
pick[9] = "StoneDecayingRoomWall4_:9 1";//鼠标中键获得方块
/*tileEntity[9] = "";//方块实体值*/
...
textureFileYP[9] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[9] = "StoneDecayingRoomWall4_1.png";//北面贴图
textureFileZP[9] = "StoneDecayingRoomWall0_1.png";//南面贴图
...
light[10] = 0;//光照强度
pick[10] = "StoneDecayingRoomWall4_:10 1";//鼠标中键获得方块
/*tileEntity[10] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[10] = "StoneDecayingRoomWall0_1.png";//西面贴图
...
textureFileZN[10] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[10] = "StoneDecayingRoomWall4_1.png";//南面贴图
...
light[11] = 0;//光照强度
pick[11] = "StoneDecayingRoomWall4_:11 1";//鼠标中键获得方块
/*tileEntity[11] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[11] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[11] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[11] = "StoneDecayingRoomWall4_1.png";//底部贴图
...
light[12] = 0;//光照强度
pick[12] = "StoneDecayingRoomWall4_:12 1";//鼠标中键获得方块
/*tileEntity[12] = "";//方块实体值*/
...
textureFileYN[12] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[12] = "StoneDecayingRoomWall4_1.png";//顶部贴图
textureFileZN[12] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[12] = "StoneDecayingRoomWall0_1.png";//南面贴图
...
light[13] = 0;//光照强度
pick[13] = "StoneDecayingRoomWall4_:13 1";//鼠标中键获得方块
/*tileEntity[13] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[13] = "StoneDecayingRoomWall4_1.png";//西面贴图
textureFileXP[13] = "StoneDecayingRoomWall0_1.png";//东面贴图
textureFileYN[13] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[13] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[13] = "StoneDecayingRoomWall0_1.png";//北面贴图
...
light[14] = 0;//光照强度
pick[14] = "StoneDecayingRoomWall4_:14 1";//鼠标中键获得方块
/*tileEntity[14] = "";//方块实体值*/
...
textureFileXP[14] = "StoneDecayingRoomWall4_1.png";//东面贴图
textureFileYN[14] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[14] = "StoneDecayingRoomWall0_1.png";//顶部贴图
...
light[15] = 0;//光照强度
pick[15] = "StoneDecayingRoomWall4_:15 1";//鼠标中键获得方块
/*tileEntity[15] = "";//方块实体值*/
...
textureFileYN[15] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[15] = "StoneDecayingRoomWall0_1.png";//顶部贴图
