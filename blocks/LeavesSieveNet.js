...
/*元数据0*/
/*属性*/
drop[0] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[0] = "0";//经验掉落
...
information[0] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[0] = 0;//光照强度
pick[0] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[0] = 0;//爆炸抗性
tileEntity[0] = "entityLeavesSieveNet0";//方块实体值
...
textureFileYN[0] = "LeavesSieveNet.png";//底部贴图
textureFileYP[0] = "LeavesSieveNet.png";//顶部贴图
...
/*元数据1*/
/*属性*/
drop[1] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[1] = "0";//经验掉落
...
information[1] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[1] = 0;//光照强度
pick[1] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[1] = 0;//爆炸抗性
tileEntity[1] = "entityLeavesSieveNet1";//方块实体值
...
/*贴图*/
textureFileXN[1] = "LeavesSieveNetLink.png";//西面贴图
textureFileXP[1] = "Blank.png";//东面贴图
textureFileYN[1] = "LeavesSieveNet.png";//底部贴图
textureFileYP[1] = "LeavesSieveNet.png";//顶部贴图
...
/*元数据2*/
/*属性*/
drop[2] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[2] = "0";//经验掉落
...
information[2] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[2] = 0;//光照强度
pick[2] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[2] = 0;//爆炸抗性
tileEntity[2] = "entityLeavesSieveNet1";//方块实体值
...
textureFileXP[2] = "LeavesSieveNetLink.png";//东面贴图
textureFileYN[2] = "LeavesSieveNet.png";//底部贴图
textureFileYP[2] = "LeavesSieveNet.png";//顶部贴图
...
/*元数据3*/
/*属性*/
drop[3] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[3] = "0";//经验掉落
...
information[3] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[3] = 0;//光照强度
pick[3] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[3] = 0;//爆炸抗性
tileEntity[3] = "entityLeavesSieveNet1";//方块实体值
...
textureFileYN[3] = "LeavesSieveNet.png";//底部贴图
textureFileYP[3] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[3] = "LeavesSieveNetLink.png";//北面贴图
...
/*元数据4*/
/*属性*/
drop[4] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[4] = "0";//经验掉落
...
information[4] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[4] = 0;//光照强度
pick[4] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[4] = 0;//爆炸抗性
tileEntity[4] = "entityLeavesSieveNet1";//方块实体值
...
textureFileYN[4] = "LeavesSieveNet.png";//底部贴图
textureFileYP[4] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[4] = "Blank.png";//北面贴图
textureFileZP[4] = "LeavesSieveNetLink";//南面贴图
...
/*元数据5*/
/*属性*/
drop[5] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[5] = "0";//经验掉落
...
information[5] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[5] = 0;//光照强度
pick[5] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[5] = 0;//爆炸抗性
tileEntity[5] = "entityLeavesSieveNet1";//方块实体值
...
/*贴图*/
textureFileXN[5] = "LeavesSieveNetLink.png";//西面贴图
textureFileXP[5] = "LeavesSieveNetLink.png";//东面贴图
textureFileYN[5] = "LeavesSieveNet.png";//底部贴图
textureFileYP[5] = "LeavesSieveNet.png";//顶部贴图
...
/*元数据6*/
/*属性*/
drop[6] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[6] = "0";//经验掉落
...
information[6] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[6] = 0;//光照强度
pick[6] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[6] = 0;//爆炸抗性
tileEntity[6] = "entityLeavesSieveNet1";//方块实体值
...
/*贴图*/
textureFileXN[6] = "LeavesSieveNetLink.png";//西面贴图
textureFileXP[6] = "Blank.png";//东面贴图
textureFileYN[6] = "LeavesSieveNet.png";//底部贴图
textureFileYP[6] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[6] = "LeavesSieveNetLink.png";//北面贴图
...
/*元数据7*/
/*属性*/
drop[7] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[7] = "0";//经验掉落
...
information[7] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[7] = 0;//光照强度
pick[7] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[7] = 0;//爆炸抗性
tileEntity[7] = "entityLeavesSieveNet1";//方块实体值
...
/*贴图*/
textureFileXN[7] = "LeavesSieveNetLink.png";//西面贴图
textureFileXP[7] = "Blank.png";//东面贴图
textureFileYN[7] = "LeavesSieveNet.png";//底部贴图
textureFileYP[7] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[7] = "Blank.png";//北面贴图
textureFileZP[7] = "LeavesSieveNetLink.png";//南面贴图
...
/*元数据8*/
/*属性*/
drop[8] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[8] = "0";//经验掉落
...
information[8] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[8] = 0;//光照强度
pick[8] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[8] = 0;//爆炸抗性
tileEntity[8] = "entityLeavesSieveNet1";//方块实体值
...
textureFileXP[8] = "LeavesSieveNetLink.png";//东面贴图
textureFileYN[8] = "LeavesSieveNet.png";//底部贴图
textureFileYP[8] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[8] = "LeavesSieveNetLink.png";//北面贴图
...
/*元数据9*/
/*属性*/
drop[9] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[9] = "0";//经验掉落
...
information[9] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[9] = 0;//光照强度
pick[9] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[9] = 0;//爆炸抗性
tileEntity[9] = "entityLeavesSieveNet1";//方块实体值
...
textureFileXP[9] = "LeavesSieveNetLink.png";//东面贴图
textureFileYN[9] = "LeavesSieveNet.png";//底部贴图
textureFileYP[9] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[9] = "Blank.png";//北面贴图
textureFileZP[9] = "LeavesSieveNetLink.png";//南面贴图
...
/*元数据10*/
/*属性*/
drop[10] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[10] = "0";//经验掉落
...
information[10] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[10] = 0;//光照强度
pick[10] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[10] = 0;//爆炸抗性
tileEntity[10] = "entityLeavesSieveNet1";//方块实体值
...
textureFileYN[10] = "LeavesSieveNet.png";//底部贴图
textureFileYP[10] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[10] = "LeavesSieveNetLink.png";//北面贴图
textureFileZP[10] = "LeavesSieveNetLink.png";//南面贴图
...
/*元数据11*/
/*属性*/
drop[11] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[11] = "0";//经验掉落
...
information[11] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[11] = 0;//光照强度
pick[11] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[11] = 0;//爆炸抗性
tileEntity[11] = "entityLeavesSieveNet1";//方块实体值
...
/*贴图*/
textureFileXN[11] = "LeavesSieveNetLink.png";//西面贴图
textureFileXP[11] = "LeavesSieveNetLink.png";//东面贴图
textureFileYN[11] = "LeavesSieveNet.png";//底部贴图
textureFileYP[11] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[11] = "LeavesSieveNetLink.png";//北面贴图
...
/*元数据12*/
/*属性*/
drop[12] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[12] = "0";//经验掉落
...
information[12] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[12] = 0;//光照强度
pick[12] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[12] = 0;//爆炸抗性
tileEntity[12] = "entityLeavesSieveNet1";//方块实体值
...
/*贴图*/
textureFileXN[12] = "LeavesSieveNetLink.png";//西面贴图
textureFileXP[12] = "LeavesSieveNetLink.png";//东面贴图
textureFileYN[12] = "LeavesSieveNet.png";//底部贴图
textureFileYP[12] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[12] = "Blank.png";//北面贴图
textureFileZP[12] = "LeavesSieveNetLink.png";//南面贴图
...
/*元数据13*/
/*属性*/
drop[13] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[13] = "0";//经验掉落
...
information[13] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[13] = 0;//光照强度
pick[13] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[13] = 0;//爆炸抗性
tileEntity[13] = "entityLeavesSieveNet1";//方块实体值
...
/*贴图*/
textureFileXN[13] = "LeavesSieveNetLink.png";//西面贴图
textureFileXP[13] = "Blank.png";//东面贴图
textureFileYN[13] = "LeavesSieveNet.png";//底部贴图
textureFileYP[13] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[13] = "LeavesSieveNetLink.png";//北面贴图
textureFileZP[13] = "LeavesSieveNetLink.png";//南面贴图
...
/*元数据14*/
/*属性*/
drop[14] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[14] = "0";//经验掉落
...
information[14] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[14] = 0;//光照强度
pick[14] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[14] = 0;//爆炸抗性
tileEntity[14] = "entityLeavesSieveNet1";//方块实体值
...
textureFileXP[14] = "LeavesSieveNetLink.png";//东面贴图
textureFileYN[14] = "LeavesSieveNet.png";//底部贴图
textureFileYP[14] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[14] = "LeavesSieveNetLink.png";//北面贴图
textureFileZP[14] = "LeavesSieveNetLink.png";//南面贴图
...
/*元数据15*/
/*属性*/
drop[15] = "minefantasy2:MF_Com_vine 6";//掉落物
expDrop[15] = "0";//经验掉落
...
information[15] = "§8这是一张具有弹性的网|§e可装配在木质筛子框架上|§c孔网大小:100|§3耐久:1000";//显示信息
light[15] = 0;//光照强度
pick[15] = "jinshucraft:LeavesSieveNet:0";//鼠标中键获得方块
resistance[15] = 0;//爆炸抗性
tileEntity[15] = "entityLeavesSieveNet1";//方块实体值
...
/*贴图*/
textureFileXN[15] = "LeavesSieveNetLink.png";//西面贴图
textureFileXP[15] = "LeavesSieveNetLink.png";//东面贴图
textureFileYN[15] = "LeavesSieveNet.png";//底部贴图
textureFileYP[15] = "LeavesSieveNet.png";//顶部贴图
textureFileZN[15] = "LeavesSieveNetLink.png";//北面贴图
textureFileZP[15] = "LeavesSieveNetLink.png";//南面贴图
