...
/*元数据0*/
/*属性*/
drop[0] = "jinshucraft:WoodenDecayingRoom";//掉落物
expDrop[0] = "0";//经验掉落
...
information[0] = "§8这破东西造价真贵||§5腐化下方5*5*5范围|§6接收上方水3*1*3范围|§9运作一次时间期望:30s|§a运作一次消耗水:200mb";//显示信息
light[0] = 0;//光照强度
pick[0] = "WoodenDecayingRoom:0 1";//鼠标中键获得方块
resistance[0] = 0.5;//爆炸抗性
tileEntity[0] = "entityWoodenDecayingRoom";//方块实体值
...
/*贴图*/
textureFileXN[0] = "WoodenDecayingRoom.png";//西面贴图
textureFileXP[0] = "WoodenDecayingRoom.png";//东面贴图
textureFileYN[0] = "WoodenDecayingRoom_Top.png";//底部贴图
textureFileYP[0] = "WoodenDecayingRoom_Top.png";//顶部贴图
textureFileZN[0] = "WoodenDecayingRoom.png";//北面贴图
textureFileZP[0] = "WoodenDecayingRoom.png";//南面贴图

/*触发器*/
onUpdate[0] = "mod.loadScript('WoodenDecayingRoomWorking.js');";

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*元数据1*/
/*属性*/
drop[1] = "jinshucraft:WoodenDecayingRoom";//掉落物
expDrop[1] = "0";//经验掉落
...
information[1] = "§8工作中,请勿打扰||§5腐化下方5*5*5范围|§6接收上方水3*1*3范围|§9运作一次时间期望:30s|§a运作一次消耗水:200mb";//显示信息
light[1] = 0;//光照强度
pick[1] = "WoodenDecayingRoom:1 1";//鼠标中键获得方块
resistance[1] = 0.5;//爆炸抗性
tileEntity[1] = "entityWoodenDecayingRoom";//方块实体值
...
/*贴图*/
textureFileXN[1] = "WoodenDecayingRoom.png";//西面贴图
textureFileXP[1] = "WoodenDecayingRoom.png";//东面贴图
textureFileYN[1] = "WoodenDecayingRoom_Top.png";//底部贴图
textureFileYP[1] = "WoodenDecayingRoom_Top.png";//顶部贴图
textureFileZN[1] = "WoodenDecayingRoom.png";//北面贴图
textureFileZP[1] = "WoodenDecayingRoom.png";//南面贴图

/*触发器*/
onUpdate[1] = "mod.loadScript('WoodenDecayingRoomWorking.js');";