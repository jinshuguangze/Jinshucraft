...
drop[0] = "jinshucraft:itemWood:4 2";//掉落物
expDrop[0] = "0";//经验掉落
...
information[0] = "§8你又成功的扒了一棵树的皮";//显示信息
light[0] = 0;//光照强度
material = "wood";//材料类型
maxStack = 64;//最大堆叠
name = "SkinnedPalmWood";//名称
opacity = 255;//遮光率
pick[0] = "SkinnedPalmWood:0 1";//鼠标中键获得方块
...
/*贴图*/
textureFileBack[0] = "PalmWood_Top.png";//底面贴图
textureFileFront[0] = "PalmWood_Top.png";//顶面贴图
textureFileSides[0] = "SkinnedPalmWood.png";//边面贴图
...
drop[1] = "jinshucraft:itemWood:4 2";//掉落物
expDrop[1] = "0";//经验掉落
...
information[1] = "§8你又成功的扒了一棵树的皮";//显示信息
light[1] = 0;//光照强度
material = "wood";//材料类型
maxStack = 64;//最大堆叠
name = "SkinnedPalmWood";//名称
opacity = 255;//遮光率
pick[1] = "SkinnedPalmWood:1 1";//鼠标中键获得方块
...
/*贴图*/
textureFileBack[1] = "PalmWood_Top.png";//底面贴图
textureFileFront[1] = "PalmWood_Top.png";//顶面贴图
textureFileSides[1] = "SkinnedPalmWood.png";//边面贴图
