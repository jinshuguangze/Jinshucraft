...
material = "rock";//材料类型
maxStack = 64;//最大堆叠
name = "StoneDecayingRoomWall3_";//名称
opacity = 255;//遮光率
...
light[0] = 0;//光照强度
pick[0] = "StoneDecayingRoomWall3_:0 1";//鼠标中键获得方块
/*tileEntity[0] = "";//方块实体值*/
...
textureFileZN[0] = "StoneDecayingRoomWall3_1.png";//北面贴图
textureFileZP[0] = "StoneDecayingRoomWall3_3.png";//南面贴图
...
light[1] = 0;//光照强度
pick[1] = "StoneDecayingRoomWall3_:1 1";//鼠标中键获得方块
/*tileEntity[1] = "";//方块实体值*/
...
textureFileYN[1] = "StoneDecayingRoomWall2_6.png";//底部贴图
textureFileYP[1] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[1] = "StoneDecayingRoomWall2_1.png";//北面贴图
...
light[2] = 0;//光照强度
pick[2] = "StoneDecayingRoomWall3_:2 1";//鼠标中键获得方块
/*tileEntity[2] = "";//方块实体值*/
...
textureFileYN[2] = "StoneDecayingRoomWall2_3.png";//底部贴图
textureFileYP[2] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[2] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[2] = "StoneDecayingRoomWall2_3.png";//南面贴图
...
light[3] = 0;//光照强度
pick[3] = "StoneDecayingRoomWall3_:3 1";//鼠标中键获得方块
/*tileEntity[3] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[3] = "StoneDecayingRoomWall0_1.png";//西面贴图
textureFileXP[3] = "StoneDecayingRoomWall2_6.png";//东面贴图
textureFileYN[3] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[3] = "StoneDecayingRoomWall2_6.png";//顶部贴图
textureFileZN[3] = "StoneDecayingRoomWall2_4.png";//北面贴图
...
light[4] = 0;//光照强度
pick[4] = "StoneDecayingRoomWall3_:4 1";//鼠标中键获得方块
/*tileEntity[4] = "";//方块实体值*/
...
textureFileYP[4] = "StoneDecayingRoomWall2_3.png";//顶部贴图
textureFileZN[4] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[4] = "StoneDecayingRoomWall2_6.png";//南面贴图
...
light[5] = 0;//光照强度
pick[5] = "StoneDecayingRoomWall3_:5 1";//鼠标中键获得方块
/*tileEntity[5] = "";//方块实体值*/
...
textureFileYN[5] = "StoneDecayingRoomWall3_3.png";//底部贴图
textureFileYP[5] = "StoneDecayingRoomWall3_3.png";//顶部贴图
textureFileZN[5] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[5] = "StoneDecayingRoomWall0_1.png";//南面贴图
...
light[6] = 0;//光照强度
pick[6] = "StoneDecayingRoomWall3_:6 1";//鼠标中键获得方块
/*tileEntity[6] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[6] = "StoneDecayingRoomWall3_1.png";//西面贴图
textureFileXP[6] = "StoneDecayingRoomWall3_3.png";//东面贴图
textureFileYN[6] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[6] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[6] = "StoneDecayingRoomWall2_2.png";//北面贴图
...
light[7] = 0;//光照强度
pick[7] = "StoneDecayingRoomWall3_:7 1";//鼠标中键获得方块
/*tileEntity[7] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[7] = "StoneDecayingRoomWall3_3.png";//西面贴图
textureFileXP[7] = "StoneDecayingRoomWall3_1.png";//东面贴图
textureFileYN[7] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[7] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[7] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[7] = "StoneDecayingRoomWall2_2.png";//南面贴图
...
light[8] = 0;//光照强度
pick[8] = "StoneDecayingRoomWall3_:8 1";//鼠标中键获得方块
/*tileEntity[8] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[8] = "StoneDecayingRoomWall3_2.png";//西面贴图
textureFileXP[8] = "StoneDecayingRoomWall3_2.png";//东面贴图
textureFileYN[8] = "StoneDecayingRoomWall2_2.png";//底部贴图
...
light[9] = 0;//光照强度
pick[9] = "StoneDecayingRoomWall3_:9 1";//鼠标中键获得方块
/*tileEntity[9] = "";//方块实体值*/
...
/*贴图*/
textureFileXN[9] = "StoneDecayingRoomWall3_4.png";//西面贴图
textureFileXP[9] = "StoneDecayingRoomWall3_4.png";//东面贴图
textureFileYN[9] = "StoneDecayingRoomWall0_1.png";//底部贴图
textureFileYP[9] = "StoneDecayingRoomWall2_2.png";//顶部贴图
...
light[10] = 0;//光照强度
pick[10] = "StoneDecayingRoomWall3_:10 1";//鼠标中键获得方块
/*tileEntity[10] = "";//方块实体值*/
...
textureFileZN[10] = "StoneDecayingRoomWall4_1.png";//北面贴图
...
light[11] = 0;//光照强度
pick[11] = "StoneDecayingRoomWall3_:11 1";//鼠标中键获得方块
/*tileEntity[11] = "";//方块实体值*/
...
textureFileYN[11] = "StoneDecayingRoomWall3_4.png";//底部贴图
textureFileYP[11] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[11] = "StoneDecayingRoomWall3_2.png";//北面贴图
...
light[12] = 0;//光照强度
pick[12] = "StoneDecayingRoomWall3_:12 1";//鼠标中键获得方块
/*tileEntity[12] = "";//方块实体值*/
...
textureFileYN[12] = "StoneDecayingRoomWall3_2.png";//底部贴图
textureFileYP[12] = "StoneDecayingRoomWall0_1.png";//顶部贴图
textureFileZN[12] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[12] = "StoneDecayingRoomWall3_2.png";//南面贴图
...
light[13] = 0;//光照强度
pick[13] = "StoneDecayingRoomWall3_:13 1";//鼠标中键获得方块
/*tileEntity[13] = "";//方块实体值*/
...
textureFileYP[13] = "StoneDecayingRoomWall3_4.png";//顶部贴图
textureFileZN[13] = "StoneDecayingRoomWall3_4.png";//北面贴图
...
light[14] = 0;//光照强度
pick[14] = "StoneDecayingRoomWall3_:14 1";//鼠标中键获得方块
/*tileEntity[14] = "";//方块实体值*/
...
textureFileYP[14] = "StoneDecayingRoomWall3_2.png";//顶部贴图
textureFileZN[14] = "StoneDecayingRoomWall0_1.png";//北面贴图
textureFileZP[14] = "StoneDecayingRoomWall3_4.png";//南面贴图
...
light[15] = 0;//光照强度
pick[15] = "StoneDecayingRoomWall3_:15 1";//鼠标中键获得方块
/*tileEntity[15] = "";//方块实体值*/
...
textureFileYN[15] = "StoneDecayingRoomWall4_1.png";//底部贴图
textureFileYP[15] = "StoneDecayingRoomWall4_1.png";//顶部贴图
